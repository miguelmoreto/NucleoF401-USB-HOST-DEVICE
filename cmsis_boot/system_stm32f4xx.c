/**
  ...
  *
  * Patched by Moreto to configure the clock for the STM32F401RET6 presented in
  * Nucleo-F401. Clock if configured as external with 8MHz frequency.
  *             
